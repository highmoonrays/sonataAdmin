 ...
 */
final class Version20200228100128 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX tblProductData ON tblProductData (intProductDataId)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX tblProductData ON tblProductData');
    }
}
